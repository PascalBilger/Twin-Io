...
#define ADC0_DRDY_GPIO_Port GPIOC
#define ADC0_DRDY_EXTI_IRQn EXTI1_IRQn
#define ADC1_DONE_Pin GPIO_PIN_2
...
#define ADC0_CS_Pin GPIO_PIN_6
#define ADC0_CS_GPIO_Port GPIOC
#define ADC1_CS_Pin GPIO_PIN_7
